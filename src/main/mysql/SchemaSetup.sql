...
ALTER TABLE FILE_HASH_HISTORY MODIFY COMMIT_TIME 	LONG NOT NULL;

-- ALTER TABLE FILE_HASH_HISTORY ADD (CHECKOUT_ID 	VARCHAR(255), RESULT  VARCHAR(255), COMPLETED BOOLEAN DEFAULT FALSE);
